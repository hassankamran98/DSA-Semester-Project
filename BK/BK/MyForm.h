...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// richTextBox1
			// 
			this->richTextBox1->Location = System::Drawing::Point(34, 163);
			this->richTextBox1->Name = L"richTextBox1";
			this->richTextBox1->Size = System::Drawing::Size(201, 141);
			...
			this->panel1->Location = System::Drawing::Point(376, 31);
			this->panel1->Name = L"panel1";
			this->panel1->Size = System::Drawing::Size(210, 126);
			...
			this->radioButton3->Location = System::Drawing::Point(3, 60);
			this->radioButton3->Name = L"radioButton3";
			this->radioButton3->Size = System::Drawing::Size(158, 17);
			this->radioButton3->TabIndex = 2;
			this->radioButton3->TabStop = true;
			this->radioButton3->Text = L"Check a sentence is correct";
			...
			this->radioButton2->Location = System::Drawing::Point(3, 37);
			this->radioButton2->Name = L"radioButton2";
			this->radioButton2->Size = System::Drawing::Size(140, 17);
			this->radioButton2->TabIndex = 1;
			this->radioButton2->TabStop = true;
			this->radioButton2->Text = L"Check a word is correct ";
			...
			this->radioButton1->Location = System::Drawing::Point(3, 14);
			this->radioButton1->Name = L"radioButton1";
			this->radioButton1->Size = System::Drawing::Size(94, 17);
			this->radioButton1->TabIndex = 0;
			this->radioButton1->TabStop = true;
			this->radioButton1->Text = L"Search a word";
			this->radioButton1->UseVisualStyleBackColor = false;
			// 
			// button6
			// 
			this->button6->Location = System::Drawing::Point(132, 100);
			...
			this->panel2->Location = System::Drawing::Point(34, 45);
			this->panel2->Name = L"panel2";
			this->panel2->Size = System::Drawing::Size(210, 90);
			...
			this->button2->Text = L"Correct word";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &MyForm::button2_Click);
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(6, 15);
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(109, 53);
			...
			this->panel3->Location = System::Drawing::Point(37, 45);
			this->panel3->Name = L"panel3";
			this->panel3->Size = System::Drawing::Size(241, 100);
			this->panel3->TabIndex = 13;
			// 
			// textBox4
			// 
			this->textBox4->Enabled = false;
			this->textBox4->Location = System::Drawing::Point(3, 36);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(3, 66);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Check word";
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(136, 66);
			...
			this->panel4->Location = System::Drawing::Point(34, 42);
			this->panel4->Name = L"panel4";
			this->panel4->Size = System::Drawing::Size(301, 100);
			this->panel4->TabIndex = 14;
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(3, 64);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(110, 23);
			this->button3->TabIndex = 5;
			this->button3->Text = L"Correct sentence";
			this->button3->UseVisualStyleBackColor = true;
			this->button3->Click += gcnew System::EventHandler(this, &MyForm::button3_Click);
			// 
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(3, 11);
			this->textBox3->Name = L"textBox3";
			this->textBox3->Size = System::Drawing::Size(285, 20);
			this->textBox3->TabIndex = 6;
			// 
			// button8
			// 
			this->button8->Location = System::Drawing::Point(211, 64);
			...
			this->ClientSize = System::Drawing::Size(607, 348);
			...
			this->MaximumSize = System::Drawing::Size(623, 387);
			this->Name = L"MyForm";
			this->Text = L"BK Dictionary";
...
#pragma endregion
		...
		void spell_corrector(string word, string root_word, word_tree *node) {
			...
			if (dist == 0) {
				...
				if (foo == 0) {
					richTextBox1->Text = "No suggestions found";
				}
